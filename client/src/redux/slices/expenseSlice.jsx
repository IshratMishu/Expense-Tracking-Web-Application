...
export const addExpense = createAsyncThunk(
    ...
    async (newExpense, { rejectWithValue }) => {
        try {
            const response = await axios.post(`${BASE_URL}/addExpense`, newExpense);
    ...
    extraReducers: (builder) => {
        ...
        builder
            ...
            .addCase(addExpense.pending, (state) => {
                state.status = 'loading'; // Mark as loading when the add request is initiated
            })
            .addCase(addExpense.fulfilled, (state, action) => {
                ...
                state.status = 'succeeded'; // Mark as succeeded when the add is successful
            })
            .addCase(addExpense.rejected, (state, action) => {
                state.status = 'failed'; // Mark as failed if the add fails
                state.error = action.payload; // Store the error message
            });
    },
});
